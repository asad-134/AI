"""
Agent Coordinator - Manages interaction between agents and OpenRouter LLM
...
class AgentCoordinator:
    """
    Coordinates between Data Architect, Visualization Agent, and OpenRouter LLM (Gemma3 27B)
    """
    
    def __init__(self, model_name: str = "google/gemma-3-27b-it", api_key: Optional[str] = None):
        ...
        if self.api_key:
            ...
            print(f"⚠️ OpenRouter API key not found. Set OPENROUTER_API_KEY environment variable.")
...
"""
    ...
    def query_llm(self, prompt: str, temperature: float = 0.3) -> str:
        """
        Sends prompt to OpenRouter and returns response
        """
        ...
        try:
            headers = {
                ...
                "HTTP-Referer": "https://github.com/yourusername/dashboard",
                "X-Title": "Multi-Agent Dashboard"
            }
...
"""
        ...
        response = self.query_llm(prompt, temperature=0.5)
    ...
    def get_model_status(self) -> Dict[str, Any]:
        """
        Returns status of OpenRouter connection and model
        """
        status = {
